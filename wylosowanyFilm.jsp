    ...
    <body>
        <div id="content">
            ...
            <form method="GET" action='FilmController'>
                ...
                <input type="hidden" name="kategoria" value="<c:out value="${kategoria}"/>"/>
                <p><input type="submit" name="Losuj" value="Losuj kolejny" />   
            </form>
            <form method="GET" action='LosujController'>
                <input type="hidden" name="action" value="listkategorie"/>
                <p><input type="submit" name="Losuj" value="Strona główna" />   
            </form>
        </div>
    </body>
</html>
